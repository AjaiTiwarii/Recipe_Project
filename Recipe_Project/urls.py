...
# these files you have to import to access media from frontend to backend abd display backend media to frontend
# basically for dealing with the media files
